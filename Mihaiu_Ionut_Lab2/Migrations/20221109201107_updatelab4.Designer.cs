...
namespace Mihaiu_Ionut_Lab2.Migrations
{
    ...
    [Migration("20221109201107_updatelab4")]
    partial class updatelab4
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mihaiu_Ionut_Lab2.Models.BookCategory", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Mihaiu_Ionut_Lab2.Models.BookCategory", b =>
                {
                    ...
                    b.HasOne("Mihaiu_Ionut_Lab2.Models.Category", "Category")
                        .WithMany("BookCategories")
                        .HasForeignKey("CategoryID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
